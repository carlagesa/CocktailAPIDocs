...
Groups are where communities live in Cocktail API — they are a collection of contacts you're talking to all at once. On this page, we'll dive into the different group endpoints you can use to manage groups programmatically. We'll look at how to query, create, update, and delete groups. {{ className: 'lead' }}
...
<Row>
  <Col>
    ...
    This endpoint allows you to create a new group conversation between you and a group of your Cocktail API contacts.
...
<Row>
  <Col>
    ...
    This endpoint allows you to delete groups. Note: This will permanently delete the group, including the Auth Tokens — archive it instead if you want to be able to restore it later.
